...
enum class EnumFactory(val factory: String, val type: Int, val res_type: Items, val prod_type: Items, val image: Int, val price: Int, val res_cap: Int, val productivity_cap: Int, val coef: Int) {
    ...
    SAWMILL("Лесопилка", 0, Items.WOOD, Items.PLANKS, R.mipmap.lesopilka1_background, 0, 10, 5, -800),
    QUARRY("Камеломня", 1, Items.STONE, Items.GRANITE, R.mipmap.angel_foreground, 800, 15, 10, -1200),
    FOUNDRY("Литейный завод", 2, Items.ORE, Items.IRON, R.mipmap.granite_foreground, 2000, 30, 30, -5000);
